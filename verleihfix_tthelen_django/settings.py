"""
Django settings for verleihfix_tthelen_django project.
...
SECRET_KEY = 'ezk63jdm^#80fot9lk6i+yf-k33$al(*0n&pg+eyxw5t!(@_cx'
...
ROOT_URLCONF = 'verleihfix_tthelen_django.urls'

WSGI_APPLICATION = 'verleihfix_tthelen_django.wsgi.application'
